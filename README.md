...
- Paso a paso para la instalacion (Entorno local).
  ...
  - Tomar el script de la base de datos WEDO y ejecutarlo dentro de Laragon.
  - (Copia del GitHub) Git clone "https://github.com/Seba-Solar/WeDo.git"
...
Derechos Reservados a los creadores y colaboradores del proyecto WeDo.
